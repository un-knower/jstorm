 ...
 */
public class KryoQcBolt implements IRichBolt {
    public static final String NAME = "kyko-rule-bolt";
    ...
    public void prepare(Map map, TopologyContext topologyContext, OutputCollector outputCollector) {
        ...
        qcItem.put("qcId电话号码","01#电话号码#for (int i = 0; i < CustcontentInfo.size(); i++) {sr = CustcontentInfo.get(i);if (params.contains(sr.getMobileNo())) {result.add(sr);}}#17633169418 17603388501 17633169418 15358706933 17633205976 17603296353");
        qcItem.put("qcId语速过快","02#语速过快##130");
    }
    ...
    public void execute(Tuple tuple) {
        try {
            ...
            if (TOPOLOGY_STREAM_QC_ID.equals(tuple.getSourceStreamId())) {
                ...
                CustcontentInfo custs = (CustcontentInfo)tuple.getValueByField(CUNSTINFO);
                System.out.println("custs: " + custs.toString());
                System.out.println("custs id : " + custs.getCustinfoId());
...
//                    });
                    ...
                    ruleContext.put("CustcontentInfo", list);
